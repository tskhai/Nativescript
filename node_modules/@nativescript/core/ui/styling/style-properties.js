...
(function (VerticalAlignment) {
    ...
    VerticalAlignment.isValid = properties_1.makeValidator(VerticalAlignment.TOP, VerticalAlignment.MIDDLE, VerticalAlignment.BOTTOM, VerticalAlignment.STRETCH, VerticalAlignment.TEXTTOP, VerticalAlignment.TEXTBOTTOM, VerticalAlignment.SUPER, VerticalAlignment.SUB, VerticalAlignment.BASELINE);
...
exports.rotateXProperty = new properties_1.CssAnimationProperty({ name: "rotateX", cssName: "rotatex", defaultValue: 0, valueConverter: parseFloat });
exports.rotateXProperty.register(properties_1.Style);
exports.rotateYProperty = new properties_1.CssAnimationProperty({ name: "rotateY", cssName: "rotatey", defaultValue: 0, valueConverter: parseFloat });
exports.rotateYProperty.register(properties_1.Style);
exports.perspectiveProperty = new properties_1.CssAnimationProperty({ name: "perspective", cssName: "perspective", defaultValue: 1000, valueConverter: parseFloat });
exports.perspectiveProperty.register(properties_1.Style);
...
function convertToTransform(value) {
    ...
    return [
        ...
        [exports.rotateProperty, rotate.z],
        [exports.rotateXProperty, rotate.x],
        [exports.rotateYProperty, rotate.y],
    ];
}
...
function convertTransformValue(property, stringValue) {
    var _a = stringValue.split(",").map(parseFloat), x = _a[0], _b = _a[1], y = _b === void 0 ? x : _b, _c = _a[2], z = _c === void 0 ? y : _c;
...
exports.fontInternalProperty = new properties_1.CssProperty({ name: "fontInternal", cssName: "_fontInternal" });
...
exports.fontFamilyProperty = new properties_1.InheritedCssProperty({
    name: "fontFamily", cssName: "font-family", affectsLayout: platform_1.isIOS, valueChanged: function (target, oldValue, newValue) {
        var currentFont = target.fontInternal || font_1.Font.default;

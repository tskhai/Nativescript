    ...
    var TapAndDoubleTapGestureListenerImpl = (function (_super) {
            ...
            if (this._target.getGestureObservers(gestures_common_1.GestureTypes.doubleTap)) {
                this._tapTimeoutId = timer.setTimeout(function () {
                    if (_this._type & gestures_common_1.GestureTypes.tap) {
                        var args = _getTapArgs(gestures_common_1.GestureTypes.tap, _this._target, motionEvent);
                ...
                if (this._type & gestures_common_1.GestureTypes.tap) {
                    var args = _getTapArgs(gestures_common_1.GestureTypes.tap, this._target, motionEvent);
                    _executeCallback(this._observer, args);
                }
            }
        };
        TapAndDoubleTapGestureListenerImpl.prototype._handleDoubleTap = function (motionEvent) {
            ...
            if (this._type & gestures_common_1.GestureTypes.doubleTap) {
                var args = _getTapArgs(gestures_common_1.GestureTypes.doubleTap, this._target, motionEvent);
                _executeCallback(this._observer, args);
            }
        };
...
function _getTapArgs(type, view, e) {
    return {
        ...
        getPointerCount: function () { return e.getPointerCount(); },
        getX: function () { return utils_1.layout.toDeviceIndependentPixels(e.getX()); },
        getY: function () { return utils_1.layout.toDeviceIndependentPixels(e.getY()); }
    };
}

...
var SegmentedBar = (function (_super) {
    ...
    SegmentedBar.prototype.onLoaded = function () {
        _super.prototype.onLoaded.call(this);
        var tabWidget = this.nativeViewProtected.getTabWidget();
        if (tabWidget) {
    ...
    SegmentedBar.prototype[segmented_bar_common_1.isEnabledProperty.setNative] = function (value) {
        var tabWidget = this.nativeViewProtected.getTabWidget();
        if (tabWidget) {

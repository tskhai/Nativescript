...
var TextField = (function (_super) {
    ...
    TextField.prototype.textFieldShouldBeginEditing = function (textField) {
        this.firstEdit = true;
        return this.editable;
    };
    TextField.prototype.textFieldDidBeginEditing = function (textField) {
        this.notify({ eventName: TextField.focusEvent, object: this });
    };
    TextField.prototype.textFieldDidEndEditing = function (textField) {
        if (this.updateTextTrigger === "focusLost") {
            text_field_common_1.textProperty.nativeValueChange(this, textField.text);
        }
        this.dismissSoftInput();
    };
    TextField.prototype.textFieldShouldClear = function (textField) {
        this.firstEdit = false;
        text_field_common_1.textProperty.nativeValueChange(this, "");
        return true;
    };
    TextField.prototype.textFieldShouldReturn = function (textField) {
    ...
    TextField.prototype.textFieldShouldChangeCharactersInRangeReplacementString = function (textField, range, replacementString) {
        ...
        if (this.updateTextTrigger === "textChanged") {
            if (textField.secureTextEntry && this.firstEdit) {
                text_field_common_1.textProperty.nativeValueChange(this, replacementString);
            }
            else {
                if (range.location <= textField.text.length) {
                    ...
                    text_field_common_1.textProperty.nativeValueChange(this, newText);
                }
            }
        }
        if (this.formattedText) {
            text_field_common_1._updateCharactersInRangeReplacementString(this.formattedText, range.location, range.length, replacementString);
        }
        this.firstEdit = false;
        return true;
    };

...
exports.closeOnReturnProperty = new editable_text_base_1.Property({ name: "closeOnReturn", defaultValue: true, valueConverter: editable_text_base_1.booleanConverter });
exports.closeOnReturnProperty.register(TextFieldBase);

...
exports.iOSTabBarItemsAlignmentProperty = new properties_1.Property({ name: "iOSTabBarItemsAlignment", defaultValue: "justified" });
exports.iOSTabBarItemsAlignmentProperty.register(TabsBase);
exports.animationEnabledProperty = new properties_1.Property({ name: "animationEnabled", defaultValue: true, valueConverter: view_1.booleanConverter });
exports.animationEnabledProperty.register(TabsBase);

...
var BottomNavigation = (function (_super) {
    ...
    BottomNavigation.prototype.setItemColors = function () {
    ...
    BottomNavigation.prototype.setIconColor = function (tabStripItem, forceReload) {
        ...
        if (forceReload || (!this._unSelectedItemColor && !this._selectedItemColor)) {
            ...
            var image = this.getIcon(tabStripItem, tabStripColor);
    ...
    BottomNavigation.prototype.updateAllItemsColors = function () {
        var _this = this;
        this.setItemColors();
        if (this.tabStrip && this.tabStrip.items) {
    ...
    BottomNavigation.prototype.updateItemColors = function (tabStripItem) {
        updateBackgroundPositions(this.tabStrip, tabStripItem);

...
var Button = (function (_super) {
    ...
    Button.prototype[button_common_1.minWidthProperty.getDefault] = function () {
        var dips = org.nativescript.widgets.ViewHelper.getMinWidth(this.nativeViewProtected);
        return { value: dips, unit: "px" };
    };
    Button.prototype[button_common_1.minHeightProperty.getDefault] = function () {
        var dips = org.nativescript.widgets.ViewHelper.getMinHeight(this.nativeViewProtected);
        return { value: dips, unit: "px" };
    };
